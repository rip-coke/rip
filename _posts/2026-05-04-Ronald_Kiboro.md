...
<div class="sticky top-0 z-50">
        ...
        <select id="tabs" class="appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <option value="death">Illness and Death</option>
            <option value="wife">Wife's Tribute</option>
          <option value="daughter">Daughter's Tribute</option>
          <option value="nephew">Nephew's Tribute</option>
          <option value="neice">Neice's Tribute</option>
          <option value="grandson">Grandson's Tribute</option>
        </select>
    </div>
...
<h1 id="birth" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Birth</h1>
...
<h1 id="education" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Education and Early Life</h1>
...
<h1 id="work" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Work</h1>  
...
<h1 id="christ" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Christian Life</h1>
...
<h1 id="marriage" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Marriage</h1>
...
<h1 id="social" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Social Life</h1>
...
<h1 id="death" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Illness and Death</h1>
...
<h1 id="wife" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Wife's Tribute</h1>
...
<blockquote class='my-2'>
<p>May you rest in eternal peace and may we also find peace in your absence. You are dearly loved and missed till we meet again.</p>
...
<blockquote class='my-2'>
<p>May you rest in peace Director. </p>
...
<h1 id="nephew" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Nephew's Tribute</h1>
...
<blockquote class='my-2'>
<p>Forever in my heart until we meet again. </p>

– Dennis Njenga Kairu
</blockquote>

<h1 id="neice" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Niece's Tribute</h1>
...
<blockquote class='my-2'>
<p>Rest well, Uncle. Your words, your kindness, and your love will forever remain in my heart. </p>

– Mary Thairu
</blockquote>

<h1 id="grandson" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Grandson's Tribute</h1>
...
<blockquote class='my-2'>
<p>Rest well Director General, Tutaonana Baadaye.</p>
