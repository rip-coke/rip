---
name: Walter Odhiambo Onyango
dob: 1976-03-22
dod: 2025-12-24
county: Nairobi
pic: /assets/images/walter_onyango.jpg
fb: 
insta: 
x: 
links:
...
<div class="sticky top-0 z-50">
        ...
        <select id="tabs" class="appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <option value="mar">Marriage & Family Life </option>
            <option value="car">Career and Enterprise</option>
            <option value="att">Attributes</option>
            <option value="dea">Death</option>
            <option value="wife">Wife's Tribute</option>
            <option value="child">Children's Tribute</option>
        </select>
    </div>
...
<h1 id="edu" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Education</h1>
...
<h1 id="mar" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Marriage & Family Life</h1>
...
<h1 id="car" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Career and Enterprise</h1>
...
<h1 id="att" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Attributes</h1>
...
<h1 id="dea" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Death</h1>
...
<blockquote class='my-2'>~ Vivianne</blockquote>

<h1 id="child" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Children's Tribute</h1>
...
<blockquote class='my-2'>~ Shawn </blockquote>
...
<blockquote class='my-2'>~ Allan</blockquote> 
