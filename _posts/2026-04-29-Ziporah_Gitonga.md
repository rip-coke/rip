...
links:
  - name: Funeral Service
    href: https://www.youtube.com/live/WFwpDuo3Sq0
user: 2
layout: post
comments: true
header:
  image: /assets/images/Ziporah_Gitonga.jpg
excerpt: Ziporah Ruguru Gitonga (01 Jan 1946 - 29 Apr 2026)
---
<div class="sticky top-0 z-50">
        ...
        <select id="tabs" class="appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <option value="early">Early Life</option>
            <option value="edu">Education Life</option>
            <option value="mar">Marriage</option>
            <option value="church">Church Life</option>
            <option value="work">Work and Social Life</option>
            <option value="demise">Demise</option>
            <option value="husband">A Tribute to My Loving Wife</option>
            <option value="mother">A Tribute to Our Beloved Mum</option>
            <option value="grandma">A Tribute to Our Loving Grandma</option>
        </select>
    </div>
...
<h1 id="intro" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Introduction</h1>
...
<h1 id="early" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Early Life</h1>
...
<h1 id="edu" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Education Life</h1>
...
<h1 id="mar" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Marriage</h1>
...
<h1 id="church" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Church Life</h1>
...
<ul class='list-disc'>
  <li>National woman's guild committee member</li>
  <li> Founder of Woman's Guild Woget House Mombasa</li>
  <li> Regional Woman's Guild Committee Member and Founder of Regional Woget in Meru</li>
  <li> Chairlady Old Chogoria Presbyterial Woman's Guild</li>
  <li> Chairlady Old Mwimbi parish woman's guild</li>
  <li> Founder of Kiwek and Cokithia (Chogoria, Kimuchia, Thigaa) rental houses.</li>
  <li> Pioneer member of Kimuchia church in 1984, Woman's Guild chairlady and choir mistress. During her tenure she initiated construction of woman's guild rental houses and kitchen.</li>
  <li>Pioneer youth fellowship founder and treasurer where she remained an active youth supporter and mentor until her demise.</li>
  <li>Church Deacon in Upper Kimuchia District until her demise</li>
</ul>
...
<h1 id="intro" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Work and Social Life</h1>
...
<h1 id="demise" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">Demise</h1>

<blockquote class='my-2'>
    <p>You have fought the good fight, you have finished the race, You have kept the faith.</p>
...
<h1 id="husband" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">A Tribute to My Loving Wife</h1>
...
<h1 id="mother" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">A Tribute to Our Beloved Mum</h1>
...
<h1 id="grandma" class="font-playfair pt-6 mb-4 text-2xl font-extrabold leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-black">A Tribute to Our Loving Grandma</h1>
