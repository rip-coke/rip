...
<div class="flex flex-col h-screen overflow-hidden">
    ...
    <ul class=" hidden w-full text-center border-b border-grey p-4 text-sm font-medium text-center text-gray-500 rounded-lg shadow-sm sm:flex dark:divide-gray-700 dark:text-gray-400"> 
        <li class="w-full focus-within:z-10">
            <a href="#early" class="inline-block w-full p-4 text-gray-900 bg-gray-100 border-r border-gray-200 dark:border-gray-700 rounded-s-lg focus:ring-4 focus:ring-blue-300 active focus:outline-none dark:bg-gray-700 dark:text-black" aria-current="page">Early</a>
        </li>
        <li class="w-full focus-within:z-10">
